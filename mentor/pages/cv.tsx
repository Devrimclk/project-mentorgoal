     ...
     <div className={styles.container}>
        ...
        <body>
            <div className="body-cv">
                ...
                <div className="cv_photo">
                    <img src="https://thumbs.dreamstime.com/b/espace-de-travail-bureau-avec-le-carnet-vide-stylo-la-feuille-papier-et-l-ordinateur-portable-sur-table-en-bois-les-couleurs-doux-109641669.jpg" alt="" className="photo_cv_cv"/>
                </div>
                <div className="separator">
                    <img src="../public/image/separator" alt="" />
                </div>
                <h1 className="perso-cv">
                    Personnaliser son CV
                </h1>
                <p className="date-cv">22 novembre 2022 - Mansour NDAO</p>

                <h2 className="description-cv">Lorem ipsum dolor sit amet consectetur.
                 ...
                 <h3 className="phrase-cv">Sit amet euismod tortor a sapien</h3>
                <h4 className="explication-cv">Sit amet euismod tortor a sapien. Vitae nulla eros blandit sit accumsan ornare tellus tellus. Erat amet id risus sed. Magna lacus cras enim ultricies arcu amet ultrices. Egestas malesuada bibendum pulvinar sed sodales at bibendum.
                ...
                <h5 className="jsp-cv">Sed commodo volutpat</h5>
                <div id="rectangle"></div>
                <h6 className="suit-jsp">Sit amet euismod tortor a sapien. Vitae nulla eros blandit sit accumsan ornare tellus tellus. Erat amet id risus sed. Magna lacus cras enim ultricies arcu amet ultrices. Egestas malesuada bibendum pulvinar sed sodales at bibendum.
                ...
                <h1 className="categories">Dans la même catégorie…</h1>
               
                <div className="slide-cv">
                <SimpleSlide/>
                </div>
            </div>
        </body>
